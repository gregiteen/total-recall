...
# With specific model
/Users/greg/.nvm/versions/node/v24.12.0/bin/gemini -p "YOUR PROMPT" -m gemini-2.5-pro --sandbox=false --yolo 2>&1
...
| `-m MODEL` | Override model (e.g., `gemini-2.5-pro`) |
...
# With specific model
claude -p "YOUR PROMPT" --model claude-sonnet-4-20250514 --allowedTools Edit,Write,Bash 2>&1
...
# With specific model
/Users/greg/.nvm/versions/node/v24.12.0/bin/codex exec "YOUR PROMPT" --full-auto -m o3 2>&1
