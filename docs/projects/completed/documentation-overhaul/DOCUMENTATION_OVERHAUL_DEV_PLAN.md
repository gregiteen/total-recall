...
- **Tasks**:
  - Create `docs/setup/INSTALLATION.md` detailing:
    ...
    - Provisioning the dual-layer brain (creating config files in `~/.agent/skills/total-recall/` and project-specific files).
...
- **Tasks**:
  - Create `docs/architecture/DUAL_LAYER_BRAIN.md` detailing:
    - Global Brain (`~/.agent/skills/total-recall/memory-vault/`) vs. Project Brain (`<repo>/.agent/skills/total-recall/memory-vault/`).
