...
Total Recall operates completely database-free, utilizing a Markdown-first, grey-matter frontmatter structure. The local VFS resides in `.agent/` (global: `~/.agent/`, project-layered: `<repo-root>/.agent/`):
